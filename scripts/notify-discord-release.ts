  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Erebus prerelease is available for nightly testers."
          : "A new Erebus latest release is available.",
...
).pipe(Command.withDescription("Post a Erebus release announcement to Discord."));
