...
export const T3_CHAT_THEME_LABEL = "Erebus";
export const CODEX_THEME_ID = "codex" as const;
export const CODEX_THEME_LABEL = "Codex";
...
// Older builds stored the dark Erebus palette as a separate theme. Keep
...
/**
 * The palette Erebus wears with no theme installed, captured from the app's
...
/**
 * The standard Erebus look as a theme palette, for seeding a new theme when
 * no theme is installed. Distinct from {@link getDefaultThemeColors}, which
 * carries the flagship Erebus palette used to fill roles omitted by theme
 * files.
 */
...
/**
 * The status colors Erebus shows without a theme, read from the app's own
