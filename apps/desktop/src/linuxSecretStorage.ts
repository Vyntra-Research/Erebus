...
function getGnomeKeyringRemediationMessage(): string {
  return "Erebus could not access GNOME Keyring to save this environment credential. Install and start GNOME Keyring, then restart Erebus.";
}

function getKWalletRemediationMessage(): string {
  return "Erebus could not access KWallet to save this environment credential. Enable the KDE wallet subsystem in System Settings, then restart Erebus.";
}
