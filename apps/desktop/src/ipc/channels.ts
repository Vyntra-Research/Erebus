...
export const FLUSH_RENDERER_STORAGE_CHANNEL = "desktop:flush-renderer-storage";
...
export const GET_WINDOW_BEHAVIOR_STATE_CHANNEL = "desktop:get-window-behavior-state";
