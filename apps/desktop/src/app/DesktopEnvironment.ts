...
const make = Effect.fn("desktop.environment.make")(function* (
  ...
  const userDataDirName = isDevelopment ? "erebus-dev" : "erebus";
  ...
  return DesktopEnvironment.of({
    ...
    appUserModelId: Option.getOrElse(config.appUserModelIdOverride, () =>
      isDevelopment ? "research.vyntra.erebus.dev" : "research.vyntra.erebus",
    ),
    linuxDesktopEntryName: isDevelopment ? "erebus-dev.desktop" : "erebus.desktop",
    linuxWmClass: isDevelopment ? "erebus-dev" : "erebus",
