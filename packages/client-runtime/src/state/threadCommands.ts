...
import {
  ...
  type ForkThreadConversationInput,
...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    forkConversation: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:fork-conversation",
      execute: (input: ForkThreadConversationInput) => forkThreadConversation(input),
      scheduler,
      concurrency,
    }),
