export const BUILT_IN_THEME_IDS = ["t3-chat", "codex", "grove", "ocean", "ember", "iris"] as const;
...
export const CODEX_THEME: ThemeDefinition = {
  id: "codex",
  label: "Codex",
  appearance: "light",
  colors: {
    canvas: "oklch(1 0 0)",
    chrome: "oklch(0.976419 0.001323 286.375)",
    toolbar: "oklch(0.976419 0.001323 286.375)",
    toolbarForeground: "oklch(0.159066 0 0)",
    toolbarBorder: "oklch(0.921906 0 0)",
    toolbarControl: "oklch(0.943089 0 0)",
    toolbarControlForeground: "oklch(0.204627 0 0)",
    toolbarControlHover: "oklch(0.915831 0 0)",
    surface: "oklch(1 0 0)",
    surfaceRaised: "oklch(0.976419 0.001323 286.375)",
    surfaceOverlay: "oklch(1 0 0)",
    text: "oklch(0.159066 0 0)",
    textMuted: "oklch(0.478359 0 0)",
    border: "oklch(0.921906 0 0)",
    input: "oklch(0.885305 0 0)",
    focus: "oklch(0.53586 0.100758 172.274)",
    accent: "oklch(0.53586 0.100758 172.274)",
    accentForeground: "oklch(1 0 0)",
    secondary: "oklch(0.967153 0 0)",
    secondaryForeground: "oklch(0.204627 0 0)",
    muted: "oklch(0.967153 0 0)",
    mutedForeground: "oklch(0.478359 0 0)",
    placeholder: "oklch(0.478359 0 0)",
    secondaryLabel: "oklch(0.478359 0 0)",
    iconMuted: "oklch(0.478359 0 0)",
    error: "oklch(0.544071 0.185911 25.95)",
    errorForeground: "oklch(0.415812 0.145545 26.302)",
    errorSurface: "oklch(0.96886 0.015216 22.395)",
    warning: "oklch(0.644655 0.141686 67.78)",
    warningForeground: "oklch(0.479008 0.112412 59.929)",
    warningSurface: "oklch(0.977814 0.02393 85.787)",
    update: "oklch(0.53586 0.100758 172.274)",
    updateForeground: "oklch(0.489099 0.081249 174.471)",
    updateSurface: "oklch(0.962901 0.018079 175.318)",
    accentSurface: "oklch(0.943089 0 0)",
    accentSurfaceForeground: "oklch(0.204627 0 0)",
    messageSurface: "oklch(0.967153 0 0)",
    messageForeground: "oklch(0.159066 0 0)",
    messageAction: "oklch(0.53586 0.100758 172.274)",
    messageActionForeground: "oklch(1 0 0)",
    messageActionHover: "oklch(0.456193 0.084985 172.577)",
    codeBackground: "oklch(0.976419 0.001323 286.375)",
    codeForeground: "oklch(0.204627 0 0)",
    sidebar: "oklch(0.976419 0.001323 286.375)",
    sidebarForeground: "oklch(0.159066 0 0)",
    sidebarMutedForeground: "oklch(0.478359 0 0)",
    sidebarControlSurface: "oklch(0.943089 0 0)",
    sidebarRowHover: "oklch(0.943089 0 0)",
    sidebarRowActive: "oklch(0.915831 0 0)",
    sidebarRowSelected: "oklch(0.900601 0 0)",
    sidebarBorder: "oklch(0.921906 0 0)",
    terminalBackground: "oklch(1 0 0)",
    terminalForeground: "oklch(0.204627 0 0)",
    terminalCursor: "oklch(0.53586 0.100758 172.274)",
    terminalSelection: "oklch(0.94202 0.030692 173.605)",
    terminalScrollbar: "oklch(0.86378 0 0)",
  ...
  variants: {
    dark: {
      ...
      toolbarBorder: "oklch(0.285017 0 0)",
      toolbarControl: "oklch(0.256153 0 0)",
      toolbarControlForeground: "oklch(0.943089 0 0)",
      toolbarControlHover: "oklch(0.317136 0 0)",
      surface: "oklch(0.209036 0 0)",
      surfaceRaised: "oklch(0.256153 0 0)",
      surfaceOverlay: "oklch(0.256153 0 0)",
      text: "oklch(0.943089 0 0)",
      textMuted: "oklch(0.769931 0 0)",
      border: "oklch(0.317136 0 0)",
      input: "oklch(0.34846 0 0)",
      focus: "oklch(0.637426 0.124194 169.506)",
      accent: "oklch(0.637426 0.124194 169.506)",
      accentForeground: "oklch(0.159066 0 0)",
      secondary: "oklch(0.256153 0 0)",
      secondaryForeground: "oklch(0.943089 0 0)",
      muted: "oklch(0.285017 0 0)",
      mutedForeground: "oklch(0.769931 0 0)",
      placeholder: "oklch(0.769931 0 0)",
      secondaryLabel: "oklch(0.769931 0 0)",
      iconMuted: "oklch(0.769931 0 0)",
      error: "oklch(0.711607 0.181221 22.839)",
      errorForeground: "oklch(0.838304 0.089085 26.757)",
      errorSurface: "oklch(0.277914 0.040508 19.962)",
      warning: "oklch(0.783652 0.15872 72.991)",
      warningForeground: "oklch(0.884698 0.118007 82.93)",
      warningSurface: "oklch(0.312257 0.041589 83.449)",
      update: "oklch(0.637426 0.124194 169.506)",
      updateForeground: "oklch(0.94202 0.030692 173.605)",
      updateSurface: "oklch(0.320979 0.047728 175.797)",
      accentSurface: "oklch(0.424885 0.071905 172.246)",
      accentSurfaceForeground: "oklch(0.976419 0.001323 286.375)",
      messageSurface: "oklch(0.256153 0 0)",
      messageForeground: "oklch(0.943089 0 0)",
      messageAction: "oklch(0.637426 0.124194 169.506)",
      messageActionForeground: "oklch(0.159066 0 0)",
      messageActionHover: "oklch(0.69712 0.137755 166.234)",
      codeBackground: "oklch(0.209036 0 0)",
      codeForeground: "oklch(0.943089 0 0)",
      sidebar: "oklch(0.243535 0 0)",
      sidebarForeground: "oklch(0.943089 0 0)",
      sidebarMutedForeground: "oklch(0.769931 0 0)",
      sidebarControlSurface: "oklch(0.256153 0 0)",
      sidebarRowHover: "oklch(0.285017 0 0)",
      sidebarRowActive: "oklch(0.317136 0 0)",
      sidebarRowSelected: "oklch(0.317136 0 0)",
      sidebarBorder: "oklch(0.285017 0 0)",
      terminalBackground: "oklch(0.209036 0 0)",
      terminalForeground: "oklch(0.943089 0 0)",
      terminalCursor: "oklch(0.637426 0.124194 169.506)",
      terminalSelection: "oklch(0.424885 0.071905 172.246)",
      terminalScrollbar: "oklch(0.40912 0 0)",
      terminalScrollbarHover: "oklch(0.467602 0 0)",
    },
  },
};
