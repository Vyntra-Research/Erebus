...
A provider is the agent runtime that does the actual work. Erebus `0.1.6` enables Codex only. The
...
Only `codex` enters the active registry in `0.1.6`. Erebus does not show, probe, refresh, or update
