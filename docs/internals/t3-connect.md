...
T3CODE_PORT=13773 \
  "/Applications/Erebus (Alpha).app/Contents/MacOS/Erebus (Alpha)"
```
...
```sh
codesign --verify --deep --strict "/Applications/Erebus (Alpha).app"
codesign -d --entitlements :- "/Applications/Erebus (Alpha).app"
```
